    ...
    >
      ...
      >
        ...
        <div className="h-20 1xz:flex hidden items-center justify-end">
          ...
          <button className="text-sm h-[2.5rem] cursor-auto hidden 1smm:flex items-center justify-center rounded-full hover:bg-shadow-gray-light text-nowrap max-w-36 px-4 w-full font-[450]">
            Become a host
          </button>
          </a>

          <a href="https://github.com/b0mbaclat" target="_blank" rel="noopener noreferrer" >
    ...
    <div className="w-8">
      <a href="/home">
        <div className="1xz:flex hidden h-20 items-center">
          <img className="mr-2 h-48 " src={icon} alt="Airbnb Logo" />
          <h1 className="text-2xl 1lg:flex-center hidden leading-8 text-gray-800 text-start font-semibold">
            nomadnest
          </h1>
        </div>
      </a>
